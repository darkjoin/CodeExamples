...
class CustomSelectViewController: UIViewController {
    ...
    lazy var tableView: UITableView = {
        ...
        tableView.register(CustomSelectCell.self, forCellReuseIdentifier: cellIdentifier)
...
// MARK: Actions
extension CustomSelectViewController {
    ...
    @objc private func selectAllItem(_ buttonItem: UIBarButtonItem) {
        ...
        for row in 0..<itemSources.count {
            ...
            if let cell = tableView.cellForRow(at: IndexPath(row: row, section: 0)) as? CustomSelectCell {
                cell.isSelectedCell = cell.isSelected
    ...
    private func selectDeselectCell(tableView: UITableView, indexPath: IndexPath) {
        ...
        if let cell = tableView.cellForRow(at: indexPath) as? CustomSelectCell {
            cell.isSelectedCell = cell.isSelected
            cell.selectionStyle = .none
        }
    }
...
extension CustomSelectViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! CustomSelectCell
