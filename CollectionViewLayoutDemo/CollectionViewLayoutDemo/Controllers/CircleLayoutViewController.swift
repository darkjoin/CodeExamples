...
class CircleLayoutViewController: UIViewController {
    ...
    lazy var collectionView: UICollectionView = {
        let view = UICollectionView(frame: .zero, collectionViewLayout: CircleLayout())
...
extension CircleLayoutViewController: UICollectionViewDataSource, UICollectionViewDelegate {
